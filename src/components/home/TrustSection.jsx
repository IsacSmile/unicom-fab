...
function GoogleReviewCard({ review }) {
  return (
    <div className="w-[320px] sm:w-[380px] shrink-0 bg-white border border-[#E7E3DA] rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-[#B97832]/40 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between space-y-4 group">
      <div className="space-y-3">
        {/* Top Header: Initial Avatar & Company/Reviewer Info + Google G Logo */}
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#F5F3EE] border border-[#E7E3DA] flex items-center justify-center font-bold text-xs text-[#B97832] shrink-0">
              {review.initials}
            </div>
            <div>
              <h4 className="font-semibold text-sm text-[#101828] leading-tight group-hover:text-[#B97832] transition-colors">
                {review.company}
              </h4>
              <p className="text-xs text-[#667085] leading-tight mt-0.5">
                {review.reviewer} <span className="text-slate-300">•</span> <span className="text-slate-500">{review.role}</span>
              </p>
            </div>
          </div>
          {/* Authentic Google G SVG */}
          <div className="w-5 h-5 shrink-0 pt-0.5" title="Verified Customer Review">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] text-[#667085] font-mono">• {review.date}</span>
        </div>
      ...
      <div className="pt-3 border-t border-[#E7E3DA] flex items-center justify-between">
        <span className="text-[11px] font-mono text-[#667085] bg-[#F5F3EE] px-2.5 py-1 rounded-md border border-[#E7E3DA]">
          {review.order}
        </span>
        <span className="text-[10px] text-emerald-800 bg-emerald-50/90 px-2 py-0.5 rounded border border-emerald-200 font-medium flex items-center gap-1">
...
export function TrustSection() {
  ...
  return (
    <section className="py-20 sm:py-24 bg-[#FAF9F6] border-t border-[#E7E3DA] relative overflow-hidden">
      {/* Side Fade Gradients for Seamless Screen Transitions */}
      <div className="pointer-events-none absolute inset-y-0 left-0 w-16 sm:w-32 bg-gradient-to-r from-[#FAF9F6] to-transparent z-10" />
      <div className="pointer-events-none absolute inset-y-0 right-0 w-16 sm:w-32 bg-gradient-to-l from-[#FAF9F6] to-transparent z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-0">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
          ...
          <div className="pt-2 flex justify-center">
            <div className="inline-flex items-center gap-2.5 bg-white border border-[#E7E3DA] px-4 py-2 rounded-full shadow-xs text-xs text-[#101828] font-medium">
